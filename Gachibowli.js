// Define a larger area of interest (AOI) for Gachibowli, Hyderabad
var customBounds = ee.Geometry.Polygon(
    [[
      [78.290, 17.420], // southwest corner
      [78.440, 17.420], // southeast corner
      [78.440, 17.570], // northeast corner
      [78.290, 17.570]  // northwest corner
    ]]
  );
    ...
    if (yearlyData) {
      ...
      ['SR_B2', 'SR_B3', 'SR_B4', 'SR_B5', 'SR_B6', 'SR_B7'].forEach(function(band) {
        Export.image.toDrive({
          ...
          description: 'Landsat8_' + yearStr.getInfo() + '_' + band,
          scale: 30,
          region: customBounds,
          fileNamePrefix: 'Landsat8_' + yearStr.getInfo() + '_' + band,
          formatOptions: {
            cloudOptimized: true
          }
        });
